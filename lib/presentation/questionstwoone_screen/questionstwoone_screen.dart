...
class QuestionstwooneScreen extends StatelessWidget {
  QuestionstwooneScreen({Key? key}) : super(key: key);

  String tetanusVaccineStatus = "";
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      _buildTetanusVaccineStatus(context),
  ...
  /// Section Widget
  Widget _buildTetanusVaccineStatus(BuildContext context) {
    return Padding(
        ...
        child: Column(children: [
          CustomRadioButton(
              text: "Yes",
              value: radioList[0],
              groupValue: tetanusVaccineStatus,
              padding: EdgeInsets.symmetric(vertical: 1.v),
              onChange: (value) {
                tetanusVaccineStatus = value;
              }),
          Padding(
  ...
  /// Navigates to the questionsonethreeScreen when the action is triggered.
  onTapBtnArrowDown(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.questionsonethreeScreen);
  }

  /// Navigates to the questionsonetwoScreen when the action is triggered.
  onTapBtnArrowLeft(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.questionsonetwoScreen);
  }
}
