...
import 'package:carebuzz/presentation/signupsuccess_dialog/signupsuccess_dialog.dart';

// ignore_for_file: must_be_immutable
class QuestionstwothreeScreen extends StatelessWidget {
  QuestionstwothreeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the questionsonefiveScreen when the action is triggered.
  onTapBtnArrowDown(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.questionsonefiveScreen);
  }
